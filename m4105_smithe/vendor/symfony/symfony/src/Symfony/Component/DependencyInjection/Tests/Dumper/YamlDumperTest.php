...
class YamlDumperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDump()
    {
        ...
        $this->assertEqualYamlStructure(
                file_get_contents( self::$fixturesPath . '/yaml/services1.yml' ), $dumper->dump(),
    ...
    public function testAddParameters()
    {
        ...
        $this->assertEqualYamlStructure(
                file_get_contents( self::$fixturesPath . '/yaml/services8.yml' ), $dumper->dump(),
    ...
    public function testAddService()
    {
        ...
        $this->assertEqualYamlStructure(
                str_replace(
                        '%path%', self::$fixturesPath . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR,
                        file_get_contents( self::$fixturesPath . '/yaml/services9.yml' )
