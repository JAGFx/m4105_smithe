...
'
    ...
    public function testSelectWithSizeBiggerThanOneCanBeRequired() {
        ...
        $this->assertWidgetMatchesXpath(
                $form->createView(), array( 'attr' => array( 'class' => '' ) ),
                '/select
    [@name="name"]
    [@required="required"]
    [@size="2"]
...
'
    ...
    public function testWidgetAttributes()
    {
        ...
        $this->assertSame(
                '<input type="text" id="text" name="text" readonly="readonly" disabled="disabled" required="required" maxlength="10" pattern="\d+" class="foobar form-control" data-foo="bar" value="value" />',
                $html
        );
    }
