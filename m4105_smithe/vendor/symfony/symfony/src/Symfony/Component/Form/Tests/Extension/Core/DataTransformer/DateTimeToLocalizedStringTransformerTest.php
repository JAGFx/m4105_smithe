...
class DateTimeToLocalizedStringTransformerTest extends DateTimeTestCase
{
    ...
    public function dataProvider()
    {
        return array(
                ...
                array(
                        ...
                        null,
                        null,
                        'Mittwoch, 3. Februar 2010 um 04:05',
                        '2010-02-03 04:05:00 UTC'
                ),
    ...
    public function testReverseTransformFullTime()
    {
        ...
        $this->assertDateTimeEquals(
                $this->dateTime, $transformer->reverseTransform( '03.02.2010, 04:05:06 GMT+00:00' )
        );
    }
