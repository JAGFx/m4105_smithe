...
class ChoiceTypeTest extends \Symfony\Component\Form\Test\TypeTestCase
{
    ...
    public function testChoiceListWithScalarValues() {
        $view = $this->factory->create(
                'Symfony\Component\Form\Extension\Core\Type\ChoiceType', null, array(
        ...
        $this->assertFalse(
                $view->vars[ 'is_selected' ]( $view->vars[ 'choices' ][ 0 ], $view->vars[ 'value' ] ),
                'True value should not be pre selected'
        );
        $this->assertFalse(
                $view->vars[ 'is_selected' ]( $view->vars[ 'choices' ][ 1 ], $view->vars[ 'value' ] ),
                'False value should not be pre selected'
        );
        $this->assertFalse(
                $view->vars[ 'is_selected' ]( $view->vars[ 'choices' ][ 2 ], $view->vars[ 'value' ] ),
                'Empty value should not be pre selected'
        );
    }

    public function testChoiceListWithScalarValuesAndFalseAsPreSetData() {
        $view = $this->factory->create(
                'Symfony\Component\Form\Extension\Core\Type\ChoiceType', false, array(
                        'choices'           => $this->scalarChoices,
                        'choices_as_values' => true,
                )
        )->createView();
        ...
        $this->assertTrue(
                $view->vars[ 'is_selected' ]( $view->vars[ 'choices' ][ 1 ]->value, $view->vars[ 'value' ] ),
                'False value should be pre selected'
        );
    }
    ...
    public function testPlaceholderWithBooleanChoices() {
        ...
        $this->assertFalse(
                $view->vars[ 'is_selected' ]( $view->vars[ 'choices' ][ 1 ]->value, $view->vars[ 'value' ] ),
                'Choice "false" should not be selected'
        );
    }
    ...
    public function testPlaceholderWithBooleanChoicesWithFalseAsPreSetData() {
        ...
        $this->assertTrue(
                $view->vars[ 'is_selected' ]( $view->vars[ 'choices' ][ 1 ]->value, $view->vars[ 'value' ] ),
                'Choice "false" should be selected'
        );
    }
    ...
    public function getOptionsWithPlaceholderAndEmptyValue() {
        return array(
            // single non-expanded, not required
                'A placeholder is not used if it is explicitly set to false'                                                                                                        => array(
                        false,
                        false,
                        false,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with null as empty value'                                                                               => array(
                        false,
                        false,
                        false,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with empty string as empty value'                                                                       => array(
                        false,
                        false,
                        false,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with "bar" as empty value'                                                                              => array(
                        false,
                        false,
                        false,
                        false,
                ...
                'A placeholder is not used if empty_value is set to false [maintains BC]'                                                                                           => array(
                        false,
                        false,
                        false,
                        null,
                ...
                'An unset empty_value is automatically made an empty string in a non-required field (but null is expected here) [maintains BC]'                                     => array(
                        false,
                        false,
                        false,
                        null,
                ...
                'An empty string empty_value is used if placeholder is not set [maintains BC]'                                                                                      => array(
                        false,
                        false,
                        false,
                        null,
                ...
                'A non-empty string empty_value is used if placeholder is not set [maintains BC]'                                                                                   => array(
                        false,
                        false,
                        false,
                        null,
                ...
                'A placeholder is not used if it is an empty string and empty_value is set to false [maintains BC]'                                                                 => array(
                        false,
                        false,
                        false,
                        '',
                ...
                'An unset empty_value is automatically made an empty string in a non-required field (but null is expected here) when placeholder is an empty string [maintains BC]' => array(
                        false,
                        false,
                        false,
                        '',
                ...
                'An empty string empty_value is used if placeholder is also an empty string [maintains BC]'                                                                         => array(
                        false,
                        false,
                        false,
                        '',
                ...
                'A non-empty string empty_value is used if placeholder is an empty string [maintains BC]'                                                                           => array(
                        false,
                        false,
                        false,
                        '',
                ...
                'A non-empty string placeholder takes precedence over an empty_value set to false'                                                                                  => array(
                        false,
                        false,
                        false,
                        'foo',
                ...
                'A non-empty string placeholder takes precedence over a not set empty_value'                                                                                        => array(
                        false,
                        false,
                        false,
                        'foo',
                ...
                'A non-empty string placeholder takes precedence over an empty string empty_value'                                                                                  => array(
                        false,
                        false,
                        false,
                        'foo',
                ...
                'A non-empty string placeholder takes precedence over a non-empty string empty_value'                                                                               => array(
                        false,
                        false,
                        false,
                        'foo',
            ...
            // single non-expanded, required
                'A placeholder is not used if it is explicitly set to false when required'                                                                                          => array(
                        false,
                        false,
                        true,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with null as empty value when required'                                                                 => array(
                        false,
                        false,
                        true,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with empty string as empty value when required'                                                         => array(
                        false,
                        false,
                        true,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with "bar" as empty value when required'                                                                => array(
                        false,
                        false,
                        true,
                        false,
                ...
                'A placeholder is not used if empty_value is set to false when required [maintains BC]'                                                                             => array(
                        false,
                        false,
                        true,
                        null,
                ...
                'A placeholder is not used if empty_value is not set when required [maintains BC]'                                                                                  => array(
                        false,
                        false,
                        true,
                        null,
                ...
                'An empty string empty_value is used if placeholder is not set when required [maintains BC]'                                                                        => array(
                        false,
                        false,
                        true,
                        null,
                ...
                'A non-empty string empty_value is used if placeholder is not set when required [maintains BC]'                                                                     => array(
                        false,
                        false,
                        true,
                        null,
                ...
                'A placeholder is not used if it is an empty string and empty_value is set to false when required [maintains BC]'                                                   => array(
                        false,
                        false,
                        true,
                        '',
                ...
                'A placeholder is not used if empty_value is not set [maintains BC]'                                                                                                => array(
                        false,
                        false,
                        true,
                        '',
                ...
                'An empty string empty_value is used if placeholder is also an empty string when required [maintains BC]'                                                           => array(
                        false,
                        false,
                        true,
                        '',
                ...
                'A non-empty string empty_value is used if placeholder is an empty string when required [maintains BC]'                                                             => array(
                        false,
                        false,
                        true,
                        '',
                ...
                'A non-empty string placeholder takes precedence over an empty_value set to false when required'                                                                    => array(
                        false,
                        false,
                        true,
                        'foo',
                ...
                'A non-empty string placeholder takes precedence over an empty string empty_value when required'                                                                    => array(
                        false,
                        false,
                        true,
                        'foo',
                ...
                'A non-empty string placeholder takes precedence over a non-empty string empty_value when required'                                                                 => array(
                        false,
                        false,
                        true,
                        'foo',
            ...
            // single expanded, not required
                'A placeholder is not used if it is explicitly set to false when expanded'                                                                                          => array(
                        false,
                        true,
                        false,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with null as empty value when expanded'                                                                 => array(
                        false,
                        true,
                        false,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with empty string as empty value when expanded'                                                         => array(
                        false,
                        true,
                        false,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with "bar" as empty value when expanded'                                                                => array(
                        false,
                        true,
                        false,
                        false,
                ...
                'A placeholder is not used if empty_value is set to false when expanded [maintains BC]'                                                                             => array(
                        false,
                        true,
                        false,
                        null,
                ...
                'An unset empty_value is automatically made an empty string in a non-required field when expanded (but null is expected here) [maintains BC]'                       => array(
                        false,
                        true,
                        false,
                        null,
                ...
                'An empty string empty_value is converted to "None" in an expanded single choice field [maintains BC]'                                                              => array(
                        false,
                        true,
                        false,
                        null,
                ...
                'A non-empty string empty_value is used if placeholder is not set when expanded [maintains BC]'                                                                     => array(
                        false,
                        true,
                        false,
                        null,
                ...
                'A placeholder is not used if it is an empty string and empty_value is set to false when expanded [maintains BC]'                                                   => array(
                        false,
                        true,
                        false,
                        '',
                ...
                'An unset empty_value is automatically made an empty string in a non-required field (but null is expected here) when expanded [maintains BC]'                       => array(
                        false,
                        true,
                        false,
                        '',
                ...
                'An empty string empty_value is converted to "None" in an expanded single choice field when placeholder is an empty string [maintains BC]'                          => array(
                        false,
                        true,
                        false,
                        '',
                ...
                'A non-empty string empty_value is used if placeholder is an empty string when expanded [maintains BC]'                                                             => array(
                        false,
                        true,
                        false,
                        '',
                ...
                'A non-empty string placeholder takes precedence over an empty_value set to false when expanded'                                                                    => array(
                        false,
                        true,
                        false,
                        'foo',
                ...
                'A non-empty string placeholder takes precedence over a not set empty_value when expanded'                                                                          => array(
                        false,
                        true,
                        false,
                        'foo',
                ...
                'A non-empty string placeholder takes precedence over an empty string empty_value when expanded'                                                                    => array(
                        false,
                        true,
                        false,
                        'foo',
                ...
                'A non-empty string placeholder takes precedence over a non-empty string empty_value when expanded'                                                                 => array(
                        false,
                        true,
                        false,
                        'foo',
            ...
            // single expanded, required
                'A placeholder is not used if it is explicitly set to false when expanded and required'                                                                             => array(
                        false,
                        true,
                        true,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with null as empty value when expanded and required'                                                    => array(
                        false,
                        true,
                        true,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with empty string as empty value when expanded and required'                                            => array(
                        false,
                        true,
                        true,
                        false,
                ...
                'A placeholder is not used if it is explicitly set to false with "bar" as empty value when expanded and required'                                                   => array(
                        false,
                        true,
                        true,
                        false,
                ...
                'A placeholder is not used if empty_value is set to false when expanded and required [maintains BC]'                                                                => array(
                        false,
                        true,
                        true,
                        null,
                ...
                'A placeholder is not used if empty_value is not set when expanded and required [maintains BC]'                                                                     => array(
                        false,
                        true,
                        true,
                        null,
                ...
                'An empty string empty_value is not used in an expanded single choice field when expanded and required [maintains BC]'                                              => array(
                        false,
                        true,
                        true,
                        null,
                ...
                'A non-empty string empty_value is not used if placeholder is not set when expanded and required [maintains BC]'                                                    => array(
                        false,
                        true,
                        true,
                        null,
                ...
                'A placeholder is not used if it is an empty string and empty_value is set to false when expanded and required [maintains BC]'                                      => array(
                        false,
                        true,
                        true,
                        '',
                ...
                'A placeholder is not used as empty string if empty_value is not set when expanded and required [maintains BC]'                                                     => array(
                        false,
                        true,
                        true,
                        '',
                ...
                'An empty string empty_value is ignored in an expanded single choice field when required [maintains BC]'                                                            => array(
                        false,
                        true,
                        true,
                        'foo',
                ...
                'A non-empty string empty_value is ignored when expanded and required [maintains BC]'                                                                               => array(
                        false,
                        true,
                        true,
                        '',
                ...
                'A non-empty string placeholder is ignored when expanded and required'                                                                                              => array(
                        false,
                        true,
                        true,
                        'foo',
    ...
    public function testCustomChoiceTypeDoesNotInheritChoiceLabels() {
        ...
        $builder->add(
                'choice', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', array(
                        'choices'           => array(
                                '1' => '1',
                                '2' => '2',
                        ),
